...
Proofreader requires a valid license to work, otherwise it returns 403. Read on the [dev KB article](https://github.com/cksource/@ssmckinney/ckeditor5-knowledge-base/blob/master/testing-phase.md#wproofreader-samplemanual-test) to set it up locally.
