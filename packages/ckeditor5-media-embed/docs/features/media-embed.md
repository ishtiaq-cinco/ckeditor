...
* {@link features/media-embed-resize Resizing media embeds} &ndash; enable drag handles, a toolbar dropdown, or standalone buttons for predefined sizes plus a custom-width balloon for media widgets (premium).
