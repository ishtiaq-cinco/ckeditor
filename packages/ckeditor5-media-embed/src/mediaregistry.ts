...
import { IconView, Template } from '@ssmckinney/ckeditor5-ui';
import { IconMediaPlaceholder } from '@ssmckinney/ckeditor5-icons';
import { logWarning, toArray, type Locale } from '@ssmckinney/ckeditor5-utils';
