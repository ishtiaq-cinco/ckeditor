...
Use the demo below to try out the undo and redo mechanism. Play around with the content. Try introducing some changes and then use the toolbar buttons to undo {@icon @ssmckinney/ckeditor5-icons/theme/icons/undo.svg Undo} or redo {@icon @ssmckinney/ckeditor5-icons/theme/icons/redo.svg Redo} them.
...
<code-switcher>
```js
import { ClassicEditor, Undo } from '@ssmckinney/ckeditor5';
