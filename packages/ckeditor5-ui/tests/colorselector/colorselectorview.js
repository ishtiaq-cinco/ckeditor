...
import { IconEraser, IconCheck, IconCancel } from '@ssmckinney/ckeditor5-icons';
...
import { Collection, FocusTracker, KeystrokeHandler, keyCodes, env } from '@ssmckinney/ckeditor5-utils';
	...
	describe( 'document colors', () => {
		...
		describe( 'empty', () => {
			...
			beforeEach( () => {
				...
				// Grids rendering is deferred (https://github.com/ssmckinney/ckeditor5/issues/6192)
