...
import type { Constructor, Mixed } from '@ssmckinney/ckeditor5-utils';
 ...
 */
export function CssTransitionDisablerMixin<Base extends Constructor<View>>( view: Base ): CssTransitionDisablerMixinConstructor<Base>
{
