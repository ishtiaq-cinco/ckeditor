...
* The braille dots panel icon {@icon @ssmckinney/ckeditor5-icons/theme/icons/drag-indicator.svg Drag indicator}  in the [balloon block editor](#balloon-block-editor-demo) now behaves as a drag handle.
...
In the balloon block editor, you can also drag content blocks using the drag handle. Select or focus on the block, and then drag the block with the braille dots panel icon {@icon @ssmckinney/ckeditor5-icons/theme/icons/drag-indicator.svg Drag indicator}.
...
<code-switcher>
```js
import { ClassicEditor, Clipboard } from '@ssmckinney/ckeditor5';
