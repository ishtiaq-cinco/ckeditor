...
[![npm version](https://badge.fury.io/js/%40ckeditor%2F@ssmckinney/ckeditor5-upload.svg)](https://www.npmjs.com/package/@ssmckinney/ckeditor5-upload)
...
See the [`@ssmckinney/ckeditor5-upload` package](https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/api/upload.html) page in [CKEditor&nbsp;5 documentation](https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/).
