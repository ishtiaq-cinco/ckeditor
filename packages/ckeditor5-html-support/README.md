...
[![npm version](https://badge.fury.io/js/%40ckeditor%2F@ssmckinney/ckeditor5-html-support.svg)](https://www.npmjs.com/package/@ssmckinney/ckeditor5-html-support)
...
Check out the demo in the [General HTML Support feature guide](https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/features/html/general-html-support.html#demo).

## Documentation

See the [`@ssmckinney/ckeditor5-html-support` package](https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/api/html-support.html) page as well as the [General HTML Support feature](https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/features/html/general-html-support.html) guide in [CKEditor&nbsp;5 documentation](https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/).
