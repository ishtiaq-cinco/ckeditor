...
describe( 'ListEditing - converters - data pipeline', () => {
	...
	describe( 'skip-level lists', () => {
		...
		describe( 'upcast without enableSkipLevelLists', () => {
			it( 'should upcast skip-level wrapper as a regular list item when enableSkipLevelLists is disabled', () => {
				// Uses the main editor which does NOT have enableSkipLevelLists.
		...
		describe( 'upcast with GeneralHtmlSupport without enableSkipLevelLists', () => {
			let ghsEditor, ghsModel, ghsElement;
