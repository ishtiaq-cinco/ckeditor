...
import { Collection, type LocaleTranslate } from '@ssmckinney/ckeditor5-utils';
import { isColorStyleValue, isLengthStyleValue, isPercentageStyleValue } from '@ssmckinney/ckeditor5-engine';
