...
[![npm version](https://badge.fury.io/js/%40ckeditor%2F@ssmckinney/ckeditor5-language.svg)](https://www.npmjs.com/package/@ssmckinney/ckeditor5-language)
...
Check out the [demo in the text part language feature guide](https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/features/language.html#demo).

## Documentation

See the [`@ssmckinney/ckeditor5-language` package](https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/api/language.html) page as well as the [text part language feature](https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/features/language.html) guide in the [CKEditor&nbsp;5 documentation](https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/).
