...
1. Paste the URL to the input (eg: `https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/assets/img/malta.jpg`).
...
1. Copy image URL to clipboard (eg: `https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/assets/img/malta.jpg`).
