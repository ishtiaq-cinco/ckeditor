...
The editor below has the base image feature enabled. Click any of the images and use the contextual image toolbar {@icon @ssmckinney/ckeditor5-icons/theme/icons/text-alternative.svg Alternative text} to edit the text alternative.
