...
Click one of the images below and use the contextual image toolbar {@icon @ssmckinney/ckeditor5-icons/theme/icons/caption.svg Image caption} to toggle the caption on and off. Click the caption to edit it.
