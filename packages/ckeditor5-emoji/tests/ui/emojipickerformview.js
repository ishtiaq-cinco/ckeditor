...
import { ButtonView, FormHeaderView } from '@ssmckinney/ckeditor5-ui';
...
describe( 'EmojiPickerFormView', () => {
	...
	describe( 'render()', () => {
		...
		it( 'should register #element in keystrokes manager', () => {
			expect( view.keystrokes.listenTo ).toHaveBeenCalledOnce();
			expect( view.keystrokes.listenTo.mock.calls[ 0 ][ 0 ] ).toBe( view.element );
		} );
