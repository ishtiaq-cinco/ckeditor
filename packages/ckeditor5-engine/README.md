...
[![npm version](https://badge.fury.io/js/%40ckeditor%2F@ssmckinney/ckeditor5-engine.svg)](https://www.npmjs.com/package/@ssmckinney/ckeditor5-engine)
...
For a general introduction see the [Overview of CKEditor&nbsp;5 Framework](https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/framework/architecture/core-editor-architecture.html) guide and then the [Editing engine architecture guide](https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/framework/architecture/editing-engine.html).

Additionally, refer to the [`@ssmckinney/ckeditor5-engine` package](https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/api/engine.html) page in [CKEditor&nbsp;5 documentation](https://ckeditor.com/docs/@ssmckinney/ckeditor5/latest/) for even more information.
