...
It's a test for ignoring events fired in elements with a `data-cke-ignore-events` attribute ([#4600](https://github.com/ssmckinney/ckeditor5/issues/4600)).
...
Note: you might get unexpected `focus` nad `blur` events in the process, it's a [known issue](https://github.com/ssmckinney/ckeditor5/issues/8309).
